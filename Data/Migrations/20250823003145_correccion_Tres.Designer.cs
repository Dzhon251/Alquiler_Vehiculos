...
namespace Alquiler_Vehiculos.Data.Migrations
{
    ...
    [Migration("20250823003145_correccion_Tres")]
    partial class correccion_Tres
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Alquiler_Vehiculos.Models.Entity.VehiculosAlquiladosModel", b =>
                {
                    ...
                    b.Property<int>("VehiculosModelId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Alquiler_Vehiculos.Models.Entity.VehiculosAlquiladosModel", b =>
                {
                    ...
                    b.HasOne("Alquiler_Vehiculos.Models.Entity.VehiculoModel", "VehiculosModel")
                        .WithMany()
                        .HasForeignKey("VehiculosModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AlquilerModel");

                    b.Navigation("VehiculosModel");
                });
