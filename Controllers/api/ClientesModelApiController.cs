...
namespace Alquiler_Vehiculos.Controllers.api
{
    ...
    [ApiController]
    public class ClientesModelApiController : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        public ClientesModelApiController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: api/ClientesModelApi
        [HttpGet]
